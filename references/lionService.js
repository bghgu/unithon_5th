...
exports.insertLionQuestion = function(inputParam) {
...
exports.selectLionQuestion = function(formPercent, toPercnet, count) {
    return new Promise(function(resolve, reject) {
        var queryStr = 'SELECT ';
        queryStr += 'id, ';
        queryStr += 'question, ';
...
exports.updateLionQuestion = function(inputParam) {
    return new Promise(function(resolve, reject) {
