...
exports.insertNineQuestion = function(inputParam) {
    return new Promise(function(resolve, reject) {
        ...
        queryStr += 'question = TRIM(\"' + inputParam.question + '\"), ';
        queryStr += 'type = 2, ';
        queryStr += 'answer = CONCAT(answer , TRIM(\",' + inputParam.answer + '\")) ';
...
exports.selectNineQuestion = function(formPercent, toPercnet, count) {
    return new Promise(function(resolve, reject) {
        var queryStr = 'SELECT ';
        queryStr += 'id, ';
        queryStr += 'question, ';
...
exports.updateNineQuestion = function(inputParam) {
    return new Promise(function(resolve, reject) {
